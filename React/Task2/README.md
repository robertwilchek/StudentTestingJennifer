...
This folder contains a minimal React 18 application configured with [Vite](https://vitejs.dev/).
The single page renders a button that counts how many times it has been clicked, updating the label
from 1, 2, 3, and so on with each press.
...
1. Open VS Code at the repository root and navigate to the `React/Task2` folder.
...
├── src/
│   ├── App.jsx         # Main React component with the click counter
│   ├── App.css         # Styles for the page and button
│   └── main.jsx        # React entry script
├── vite.config.js      # Vite + React plugin configuration
└── README.md           # This guide
```

Feel free to expand the counter or add additional UI elements to experiment with React features.
